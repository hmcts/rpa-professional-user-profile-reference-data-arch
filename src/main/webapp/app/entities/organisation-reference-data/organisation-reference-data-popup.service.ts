...
@Injectable()
export class OrganisationReferenceDataPopupService {
            ...
            if (id) {
                this.organisationService.find(id)
                    .subscribe((organisationResponse: HttpResponse<OrganisationReferenceData>) => {
                        const organisation: OrganisationReferenceData = organisationResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.organisationModalRef(component, new OrganisationReferenceData());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    organisationModalRef(component: Component, organisation: OrganisationReferenceData): NgbModalRef {

...
import uk.gov.hmcts.reform.ref.pup.config.audit.AuditEventConverter;
import uk.gov.hmcts.reform.ref.pup.domain.PersistentAuditEvent;
...
import static uk.gov.hmcts.reform.ref.pup.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

...
describe('Service Tests', () => {
    ...
    describe('OrganisationTypeReferenceData Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(OrganisationTypeReferenceDataService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/organisation-types';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return OrganisationTypeReferenceData', () => {

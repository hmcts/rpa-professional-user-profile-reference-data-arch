...
describe('Service Tests', () => {
    ...
    describe('ProfessionalUserAccountAssignmentReferenceData Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ProfessionalUserAccountAssignmentReferenceDataService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/professional-user-account-assignments';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ProfessionalUserAccountAssignmentReferenceData', () => {

...
describe('Service Tests', () => {
    ...
    describe('ProfessionalUserReferenceData Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ProfessionalUserReferenceDataService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/professional-users';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ProfessionalUserReferenceData', () => {
